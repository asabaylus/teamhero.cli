...
// Three attempts handles the structural failure modes the validator
// still enforces (missing README.md / GLOSSARY.md / failing test).
// One structured Responses API call per attempt, so the budget stays
