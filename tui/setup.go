...
// Internal constants (ASANA_API_BASE_URL, ASANA_USER_AGENT, per-feature
// model overrides, legacy single-board fallback vars, internal batch/delay
// tuning) are omitted — they still appear under [Other] if present in .env.
var knownSettings = []settingDef{
	...
	// AI / LLM
	{envKey: "AI_MODEL", label: "AI Model", description: "Primary model for AI features", category: "AI", defaultVal: "gpt-5-mini", itype: inputSelect, options: []string{"gpt-5-mini", "gpt-5", "o3-mini", "o3", "o4-mini", "gpt-4.1-mini", "gpt-4.1", "gpt-4.1-nano", "custom..."}},
...
func buildSettingsPicker(allEntries map[string]string, creds []credential, allCredsValid bool) settingsPicker {
	...
	lines = append(lines, pickerLine{text: "", itemIndex: -1})
	lines = append(lines, pickerLine{
		text:      "  " + headerStyle.Render("Boards"),
		itemIndex: -1,
	})
